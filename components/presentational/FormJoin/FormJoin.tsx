...
const FormJoin = () => (
  <form>
    ...
    <button
      type="submit"
      className="mt-4 w-full text-center text-femmy-white bg-femmy-pdark hover:bg-femmy-white hover:text-femmy-pdark focus:ring-4 focus:outline-none tracking-[2px] focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 font-sans"
    >
      bergabung sekarang!
    </button>
  </form>
