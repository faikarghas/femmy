...
const CardNews: React.FC<ICardN> = ({ data, type, paragraph, height }) => (
  <div className="h-[100%] shadow-[0_0_30px_rgba(0,0,0,0.25)] rounded-2xl">
    <div
      className={`${
        type == 'big' ? 'h-[250px] lg:h-[490px]' : 'h-[200px] lg:h-[192px]'
      } bg-femmy-white rounded-t-2xl rounded-r-2xl flex flex-col justify-center items-center overflow-hidden`}
    >
      <img src="/images/news1.jpg" className="object-cover w-[100%] h-[100%]" />
    </div>
    <div className={`${height} bg-femmy-white rounded-b-2xl rounded-br-2xl flex flex-col justify-center px-6 pt-2 pb-5`}>
