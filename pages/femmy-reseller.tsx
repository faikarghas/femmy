...
const Reseller: NextPage = () => {
  return (
    <Layout page="tentang-kami">
      <main>
        <section className="bg-[#F9EFE6] py-16 px-60">
            <div className="flex justify-center items-center flex-col mb-12">
                <h1 className='text-femmy-pdark font-head text-[40px] font-semibold leading-tight'>Femmy Reseller</h1>
                <span className='text-[#EA92A7] text-[25px] font-head leading-tight'>Melangkah bersama</span>
            </div>
            <div className='mb-28'>
            ...
            <div className="flex flex-row flex-wrap">
                ...
                <div className="basis-full md:basis-[55%] pl-6">
                  <FormJoin />
                </div>
