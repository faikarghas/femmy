...
const Temukan: NextPage = ({auth}:any) => {
  return (
      ...
      <section className="bg-[#FEC8CE] pt-8 pb-16 lg:pb-24">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 px-8">
          <Link
            ...
            target="_blank" rel="noopener" className="bg-femmy-white w-[100%] lg:w-[250px] h-[100px] lg:h-[150px] rounded-full lg:rounded-2xl p-4 flex flex-row lg:flex-col justify-center items-center shadow-[7px_10px_18px_rgba(0,0,0,0.25)]">
          ...
          <Link href="/" target="_blank" rel="noopener" className="bg-femmy-white w-[100%] lg:w-[250px] h-[100px] lg:h-[150px] rounded-full lg:rounded-2xl p-4 flex flex-row lg:flex-col justify-center items-center shadow-[7px_10px_18px_rgba(0,0,0,0.25)]">
              <div className="w-[180px] flex flex-row lg:flex-col justify-left items-center">
                <img
                  alt="image-femmy"
                  className="w-[60px] h-[59px] object-contain mb-3 mr-4 lg:mr-0"
