    ...
    <Layout page="tentang-kami">
      ...
      <section className="bg-[#FEC8CE] pt-8 pb-16 lg:pb-24">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 px-8">
          ...
          >
            <a target="_blank" rel="noopener" className="bg-femmy-white w-[100%] lg:w-[250px] h-[100px] lg:h-[150px] rounded-full lg:rounded-2xl p-4 flex flex-row lg:flex-col justify-center items-center shadow-[7px_10px_18px_rgba(0,0,0,0.25)]">
