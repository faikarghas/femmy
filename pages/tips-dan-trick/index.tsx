      ...
      <main>
        <section className="relative bg-femmy-plight py-8 px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 mb-8 gap-10">
            <div className="col-span-1 shadow-[0_0_30px_rgba(0,0,0,0.25)] rounded-2xl">
              <img src="/images/news1.jpg" className="rounded-2xl"/>
            </div>
            <div className="col-span-2 px-6 pt-4 pb-12">
              ...
              <p className="font-sans text-femmy-pdark leading-4 font-medium text-[15px] mb-20 line-clamp-4">
