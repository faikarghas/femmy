    ...
    <Layout page="tentang-kami">
      <main>
        <section className="bg-[#FBEEE5]/[0.5]">
            <div className='mb-16'>
                <img src='/images/banner-kontak-femmy.jpg' className='mb-12'/>
                <h3 className='text-femmy-pdark font-head text-[30px] font-semibold leading-tight text-center mb-4'>Kontak kami</h3>
                <p className='font=sans text-[16px] text-femmy-pdark text-center mb-4'>Kontak kami untuk penjelasan lebih lanjut mengenai<br/>produk, member, maupun reseller.</p>
            </div>
            <div className='flex flex-wrap flex-row px-8 lg:px-32 gap-4 justify-between pb-14'>
                <div className='basis-[32%] border-[1px] border-femmy-pdark rounded-2xl h-[200px] flex flex-col text-center items-center py-10'>
                ...
                <div className='basis-[100%] border-[1px] border-femmy-pdark rounded-2xl h-[80px] mt-2 flex justify-center items-center font-semibold'>
