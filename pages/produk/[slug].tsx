        ...
        <Layout page="tentang-kami">
            <section className="flex flex-wrap flex-row pb-8 pt-10 lg:pt-10 px-8 lg:px-16 bg-[#FEF7F8]">
                ...
                <div className="basis-full lg:basis-[70%]">
                    <h5 className="font-head text-femmy-pdark text-[30px] mb-3 font-semibold text-center md:text-left">{data[0]?.judul}</h5>
                    <span className="font-sans text-femmy-white md:text-black text-[20px] font-semibold text-center md:text-left p-2 md:pl-0 md:pb-4 mb-6 md:mb-0 mt-8 md:mt-0 block bg-femmy-pdark md:bg-transparent rounded-full"><span className='block md:hidden font-sans text-white text-[12px] font-normal'>Beli Sekarang</span>RP {data[0]?.harga.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}.-</span>
            ...
            <section className="pb-12 pt-8 px-8 lg:px-16 bg-[#FEF7F8]">
                ...
                <div className="relative">
                    <button
                        ...
                        onClick={nextSlider}
                    ><Image src="/images/prev-button.png" width={40} height={40}/></button>
                    ...
                    <button
                        ...
                        onClick={prevSlider}
                    ><Image src="/images/next-button.png" width={40} height={40}/></button>
                </div>
            </section>
        </Layout>
    );
